...
class WordSegmentsTest extends Specification {

    WordSegments wordSegments = new WordSegments()

    def 'test word segments'() {
        given: 'parameterized'
        when: 'method called'
        def res = wordSegments.booleanArray(inputString, dict as List<String>)
